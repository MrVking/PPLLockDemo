...
@interface PPLLockHelper ()

@property (atomic,strong) NSMutableDictionary * bleBlockDict;

@end

@implementation PPLLockHelper

static  PPLLockHelper * instace;
...
+ (void)connectKey:(PPLKeyModel *)key connectBlock:(BLEBlock)connectBloc
{
    ...
    if (connectBloc) {
        ...
        [[PPLLockHelper shareInstance].bleBlockDict setObject:connectBloc forKey:PPLBLE_CONNECT];
    }
...
+ (void)GetElectricBlock:(BLEBlock)electricBlock
{
    if (electricBlock) {
        ...
        [[PPLLockHelper shareInstance].bleBlockDict setObject:electricBlock forKey:PPLBLE_ELECTIC];
    }
...
+ (void)GetDeviceInfoBlock:(BLEBlock)deviceInfoBlock
{
    if (deviceInfoBlock) {
        ...
        [[PPLLockHelper shareInstance].bleBlockDict setObject:deviceInfoBlock forKey:PPLBLE_DEVICE];
    }
...
+ (void)setLockTime:(PPLKeyModel*)key complition:(BLEBlock)complition
{
    ...
    if (complition) {
        ...
        [[PPLLockHelper shareInstance].bleBlockDict setObject:complition forKey:PPLBLE_SETLOCKTIME];
    }
...
+ (void)resetLock:(PPLKeyModel *)key  complition:(BLEBlock)complition;
{
    ...
    if (complition) {
        ...
        [[PPLLockHelper shareInstance].bleBlockDict setObject:complition forKey:PPLBLE_RETSETLOCK];
    }
...
+ (void)resetKeyboardPassword:(PPLKeyModel *)key complition:(BLEBlock)complition
{
    ...
    if (complition) {
        ...
        [[PPLLockHelper shareInstance].bleBlockDict setObject:complition forKey:PPLBLE_RETSETKEYBOARDPWD];
               ...
               complition:(BLEBlock)complition
{
    ...
    if (complition) {
        ...
        [[PPLLockHelper shareInstance].bleBlockDict setObject:complition forKey:PPLBLE_CUSTOMKEYBOARDPWD];
...
+ (void)GetLockTimeComplition:(BLEBlock)complition
{
    ...
    if (complition) {
        ...
        [[PPLLockHelper shareInstance].bleBlockDict setObject:complition forKey:PPLBLE_READLOCKTIME];
...
+ (void)setAutoLockingTime:(int)time key:(PPLKeyModel *)key complition:(BLEBlock)complition
{
    ...
    if (complition) {
        ...
        [[PPLLockHelper shareInstance].bleBlockDict setObject:complition forKey:PPLBLE_SETAUTOLOCKTIME];
...
{
    if (disConnectBlock) {
        [[PPLLockHelper shareInstance].bleBlockDict setObject:disConnectBlock forKey:PPLBLE_DISCONNECT];
    }
...
+ (void)unlock:(PPLKeyModel *)key unlockBlock:(BLEBlock)unlockBlock
{
    ...
    if (unlockBlock) {
        ...
        [[PPLLockHelper shareInstance].bleBlockDict setObject:unlockBlock forKey:PPLBLE_UNLOCK];
    }
...
+ (void)lock:(PPLKeyModel *)key lockBlock:(BLEBlock)lockBlock
{
    ...
    if (lockBlock) {
        ...
        [[PPLLockHelper shareInstance].bleBlockDict setObject:lockBlock forKey:PPLBLE_LOCK];
    }
...
+ (void)pullUnlockRecord:(PPLKeyModel *)key complition:(BLEBlock)complition
{
    ...
    if (complition) {
        ...
        [[PPLLockHelper shareInstance].bleBlockDict setObject:complition forKey:PPLBLE_PULLLOCKRECORD];
    }
...
- (void)PLLError:(PPLLockError)error command:(int)command errorMsg:(NSString *)errorMsg
{
    ...
    [PPLLockHelper removeBlock:info untilExecute:YES];
        
}

+ (void)removeBlock:(id)info untilExecute:(BOOL)execute{
    
    NSMutableDictionary *bleBlockDict = [[PPLLockHelper shareInstance].bleBlockDict copy];
    [[PPLLockHelper shareInstance].bleBlockDict removeAllObjects];
